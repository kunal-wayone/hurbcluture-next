...
import ReviewAndRating from "../../product/[productId]/components/ReviewAndRating";
import BrandProfile from "../../components/common/BrandProfile";
...
export default async function page(ctx: any) {
    ...
    const path = [
        ...
        { label: brandId, href: `/products/${brandId}` },
    ];

    const productData = await getData(`/api/product?brandId=${brandId}`);
    console.log(productData, 'dfdfdfdfdfdf');
    return (
        <AuthGuard>
            <Wrapper>
