...
export default function page() {
  return (
    <div className="bg-white mt-[9.6rem] py-4 lg:py-10">
      <HeaderSection
        title={"About"}
        subTitle={""}
        description={
      ...
      />
      <div className="grid grid-cols-1 lg:grid-cols-7 gap-4 p-4 lg:px-16">
        ...
        <div className="md:col-span-2">
          <div className="rounded-2xl p-5 bg-gray-100 mb-4">
            <h3 className="text-xl text-dark-primary font-semibold mb-4">Our Mission</h3>
